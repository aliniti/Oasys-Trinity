    ...
    public class SpellData
    {
        ...
        static SpellData()
        {
            ...
            HeroSpells.Add(new SpellData
            {
                ...
                EmuFlags = new[] { EmulationFlags.Ultimate, EmulationFlags.CrowdControl },
                CastSpeed = 3200
            });
            ...
            HeroSpells.Add(new SpellData
            {
                ...
                Slot = SpellSlot.R,
                DisplayName = "Life Form Disintegration Ray",
                CastRange = 1575f,
                Radius = 175f,
                CastDelay = 250f,
                CastType = CastType.Direction,
